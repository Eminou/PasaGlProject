...
<table class=\"records_list\">
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
            ...
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("progression_show", array("id" => $this->getAttribute($_entity_, "id"))), "html", null, true);
            echo "\">";
            if (isset($context["entity"])) { $_entity_ = $context["entity"]; } else { $_entity_ = null; }
            ...
            // line 20
            if (isset($context["entity"])) { $_entity_ = $context["entity"]; } else { $_entity_ = null; }
            if ($this->getAttribute($_entity_, "progressiondate")) {
                if (isset($context["entity"])) { $_entity_ = $context["entity"]; } else { $_entity_ = null; }
