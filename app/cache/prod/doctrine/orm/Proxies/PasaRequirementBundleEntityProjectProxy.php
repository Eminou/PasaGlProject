 ...
 */
class PasaRequirementBundleEntityProjectProxy extends \Pasa\RequirementBundle\Entity\Project implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::addExigency($exigencies);
    }
    ...
    {
        return array('__isInitialized__', 'manager', 'exigencies', 'id', 'title', 'description');
    }
