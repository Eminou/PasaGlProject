...
class appprodUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/managerfront') && preg_match('#^/managerfront/(?P<id>[^/]+?)/show$#s', $pathinfo, $matches)) {
        ...
        if ($pathinfo === '/managerfront/create') {
            if ($this->context->getMethod() != 'POST') {
                $allow[] = 'POST';
        ...
        if (0 === strpos($pathinfo, '/managerfront') && preg_match('#^/managerfront/(?P<id>[^/]+?)/edit$#s', $pathinfo, $matches)) {
        ...
        if (0 === strpos($pathinfo, '/managerfront') && preg_match('#^/managerfront/(?P<id>[^/]+?)/update$#s', $pathinfo, $matches)) {
            if ($this->context->getMethod() != 'POST') {
                $allow[] = 'POST';
        ...
        if (0 === strpos($pathinfo, '/managerfront') && preg_match('#^/managerfront/(?P<id>[^/]+?)/delete$#s', $pathinfo, $matches)) {
            if ($this->context->getMethod() != 'POST') {
                $allow[] = 'POST';
